  ...
  Describe "New-ArmDashboardsCuratedBladePerformancePinned" {
    ...
    Context "Unit tests" {
      ...
      It "Given a parameter of incorrect type, it throws '<Expected>'" -TestCases @(
        ...
        { New-ArmDashboardsCuratedBladePerformancePinned -ApplicationInsights $ApplicationInsights } | Should -Throw -ErrorId $Expected
      }
    }
    ...
    Context "Integration tests" {
      It "Default" -Test {
        ...
        {
          $part = New-ArmDashboardsCuratedBladePerformancePinned -ApplicationInsights $ApplicationInsights
